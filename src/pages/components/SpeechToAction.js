...
const SpeechToAction = ({ invoiceData, setInvoiceData }) => {
  ...
  const handleCommand = command => {
    ...
    const productMatch = lowerCommand.match(/add product (.+?) with quantity (\d+) and price (\d+)/) || lowerCommand.match(productRegex);
    ...
    if (productMatch) {
      ...
      speak(`Product ${productName} added with quantity ${quantity} and price ${price}`);
    }
  ...
  return (
    <div className="my-4">
      ...
      <ul>
        ...
        <li>
          add product <strong>Pen</strong>.
        </li>
        <li>
          add product <strong>Pen</strong> with quantity <strong>3</strong> and price <strong>50</strong>.
        </li>
        <li>
          Change name to <b>Jane</b> and add product <b>Pen</b> with quantity <b>3</b> and price <b>25</b>.
        </li>
      </ul>
      <h4>{status}</h4>
